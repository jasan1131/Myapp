...
class BuyerSpecialProduct20 extends StatefulWidget {
  final UserModel userModel;
  const BuyerSpecialProduct20({Key? key, required this.userModel})
      : super(key: key);

  @override
  State<BuyerSpecialProduct20> createState() => _BuyerSpecialProduct20State();
}

class _BuyerSpecialProduct20State extends State<BuyerSpecialProduct20> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereSp20%Seller.php';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('ส่วนลดรายการสินค้า 20%'),
        actions: [
          IconButton(

...
class BuyerSpecialProduct10 extends StatefulWidget {
  final UserModel userModel;
  const BuyerSpecialProduct10({Key? key, required this.userModel})
      : super(key: key);

  @override
  State<BuyerSpecialProduct10> createState() => _BuyerSpecialProduct10State();
}

class _BuyerSpecialProduct10State extends State<BuyerSpecialProduct10> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('ส่วนลดรายการสินค้า 10%'),
        actions: [
          IconButton(

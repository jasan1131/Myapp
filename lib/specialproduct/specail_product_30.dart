...
class BuyerSpecialProduct30 extends StatefulWidget {
  final UserModel userModel;
  const BuyerSpecialProduct30({Key? key, required this.userModel})
      : super(key: key);

  @override
  State<BuyerSpecialProduct30> createState() => _BuyerSpecialProduct30State();
}

class _BuyerSpecialProduct30State extends State<BuyerSpecialProduct30> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereSp30%Seller.php';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('ส่วนลดรายการสินค้า 30%'),
        actions: [
          IconButton(

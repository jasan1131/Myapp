...
class FoodMenuList6_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList6_2({ Key? key, required this.userModel }) : super(key: key);

  @override
  State<FoodMenuList6_2> createState() => _FoodMenuList6_2State();
}

class _FoodMenuList6_2State extends State<FoodMenuList6_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

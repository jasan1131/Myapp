...
class FoodMenuList6_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList6_7({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList6_7> createState() => _FoodMenuList6_7State();
}

class _FoodMenuList6_7State extends State<FoodMenuList6_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

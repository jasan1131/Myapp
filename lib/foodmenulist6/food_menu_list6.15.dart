...
class FoodMenuList6_15 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList6_15({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList6_15> createState() => _FoodMenuList6_15State();
}

class _FoodMenuList6_15State extends State<FoodMenuList6_15> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(รสดีหมู).php';

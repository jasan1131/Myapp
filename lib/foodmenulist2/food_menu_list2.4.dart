...
class FoodMenuList2_4 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList2_4({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList2_4> createState() => _FoodMenuList2_4State();
}

class _FoodMenuList2_4State extends State<FoodMenuList2_4> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(ต้นหอม).php';

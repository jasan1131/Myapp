...
class FoodMenuList4_4 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList4_4({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList4_4> createState() => _FoodMenuList4_4State();
}

class _FoodMenuList4_4State extends State<FoodMenuList4_4> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(กุ้งขาว).php';

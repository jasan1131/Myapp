...
class FoodMenuList4_5 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList4_5({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList4_5> createState() => _FoodMenuList4_5State();
}

class _FoodMenuList4_5State extends State<FoodMenuList4_5> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(ข่าอ่อน).php';

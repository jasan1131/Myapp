...
class FoodMenuList4_8 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList4_8({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList4_8> createState() => _FoodMenuList4_8State();
}

class _FoodMenuList4_8State extends State<FoodMenuList4_8> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(หอมแดง).php';

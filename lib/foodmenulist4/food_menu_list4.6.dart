...
class FoodMenuList4_6 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList4_6({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList4_6> createState() => _FoodMenuList4_6State();
}

class _FoodMenuList4_6State extends State<FoodMenuList4_6> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(ตะไคร้).php';

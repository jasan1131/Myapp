...
class FoodMenuList4_3 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList4_3({ Key? key, required this.userModel }) : super(key: key);

  @override
  State<FoodMenuList4_3> createState() => _FoodMenuList4_3State();
}

class _FoodMenuList4_3State extends State<FoodMenuList4_3> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(น้ำมันโอลีน).php';

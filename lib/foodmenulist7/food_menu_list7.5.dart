...
class FoodMenuList7_5 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList7_5({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList7_5> createState() => _FoodMenuList7_5State();
}

class _FoodMenuList7_5State extends State<FoodMenuList7_5> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

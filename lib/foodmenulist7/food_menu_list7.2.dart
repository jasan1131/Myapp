...
class FoodMenuList7_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList7_2({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList7_2> createState() => _FoodMenuList7_2State();
}

class _FoodMenuList7_2State extends State<FoodMenuList7_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

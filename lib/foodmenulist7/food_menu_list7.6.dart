...
class FoodMenuList7_6 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList7_6({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList7_6> createState() => _FoodMenuList7_6State();
}

class _FoodMenuList7_6State extends State<FoodMenuList7_6> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

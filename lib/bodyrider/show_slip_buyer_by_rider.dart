...
class ShowSlipBuyerByRider extends StatefulWidget {
  final OrderModel orderModel;
  const ShowSlipBuyerByRider({Key? key, required this.orderModel}) : super(key: key);

  @override
  State<ShowSlipBuyerByRider> createState() => _ShowSlipBuyerByRiderState();
}

class _ShowSlipBuyerByRiderState extends State<ShowSlipBuyerByRider> {
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            ShowTitle(
                              title:
                                  '${slipModels[index].namebuyer} ${slipModels[index].secondnamebuyer}',

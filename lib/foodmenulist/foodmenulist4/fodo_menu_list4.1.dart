...
class FoodMenuList4_1 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList4_1({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList4_1> createState() => _FoodMenuList4_1State();
}

class _FoodMenuList4_1State extends State<FoodMenuList4_1> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(พริกขี้หนู).php';

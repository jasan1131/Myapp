...
class FoodMenuList4_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList4_7({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList4_7> createState() => _FoodMenuList4_7State();
}

class _FoodMenuList4_7State extends State<FoodMenuList4_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(ใบมะกรูด).php';

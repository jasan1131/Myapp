...
class FoodMenuList4_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList4_2({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList4_2> createState() => _FoodMenuList4_2State();
}

class _FoodMenuList4_2State extends State<FoodMenuList4_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(กระเทียม).php';

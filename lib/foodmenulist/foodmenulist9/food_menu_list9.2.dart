...
class FoodMenuList9_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList9_2({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList9_2> createState() => _FoodMenuList9_2State();
}

class _FoodMenuList9_2State extends State<FoodMenuList9_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(อกไก่).php';

...
class FoodMenuList9_4 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList9_4({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList9_4> createState() => _FoodMenuList9_4State();
}

class _FoodMenuList9_4State extends State<FoodMenuList9_4> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(มะเขือเทศผลใหญ่).php';

...
class FoodMenuList9_6 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList9_6({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList9_6> createState() => _FoodMenuList9_6State();
}

class _FoodMenuList9_6State extends State<FoodMenuList9_6> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

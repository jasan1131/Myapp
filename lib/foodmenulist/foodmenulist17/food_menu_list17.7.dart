...
class FoodMenuList17_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList17_7({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList17_7> createState() => _FoodMenuList17_7State();
}

class _FoodMenuList17_7State extends State<FoodMenuList17_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ใบสะระแหน่).php';

...
class FoodMenuList17_3 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList17_3({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList17_3> createState() => _FoodMenuList17_3State();
}

class _FoodMenuList17_3State extends State<FoodMenuList17_3> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(มะนาว).php';

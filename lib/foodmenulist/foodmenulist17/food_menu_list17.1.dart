...
class FoodMenuList17_1 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList17_1({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList17_1> createState() => _FoodMenuList17_1State();
}

class _FoodMenuList17_1State extends State<FoodMenuList17_1> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(หมูสันนอก).php';

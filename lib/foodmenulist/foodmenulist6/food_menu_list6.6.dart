...
class FoodMenuList6_6 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList6_6({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList6_6> createState() => _FoodMenuList6_6State();
}

class _FoodMenuList6_6State extends State<FoodMenuList6_6> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

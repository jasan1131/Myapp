...
class FoodMenuList6_9 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList6_9({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList6_9> createState() => _FoodMenuList6_9State();
}

class _FoodMenuList6_9State extends State<FoodMenuList6_9> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ผักบุ้งจีน).php';

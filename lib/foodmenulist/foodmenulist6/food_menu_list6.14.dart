...
class FoodMenuList6_14 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList6_14({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList6_14> createState() => _FoodMenuList6_14State();
}

class _FoodMenuList6_14State extends State<FoodMenuList6_14> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(วุ้นเส้นตราต้นสน).php';

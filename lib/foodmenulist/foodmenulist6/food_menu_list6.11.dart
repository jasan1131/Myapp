...
class FoodMenuList6_11 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList6_11({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList6_11> createState() => _FoodMenuList6_11State();
}

class _FoodMenuList6_11State extends State<FoodMenuList6_11> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(เห็ดฟาง).php';

...
class FoodMenuList14_8 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList14_8({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList14_8> createState() => _FoodMenuList14_8State();
}

class _FoodMenuList14_8State extends State<FoodMenuList14_8> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ใบกะเพรา).php';

...
class FoodMenuList14_3 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList14_3({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList14_3> createState() => _FoodMenuList14_3State();
}

class _FoodMenuList14_3State extends State<FoodMenuList14_3> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(พริกจินดาแดง).php';

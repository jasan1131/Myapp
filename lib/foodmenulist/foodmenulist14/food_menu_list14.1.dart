...
class FoodMenuList14_1 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList14_1({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList14_1> createState() => _FoodMenuList14_1State();
}

class _FoodMenuList14_1State extends State<FoodMenuList14_1> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(หมูเนื้อแดงล้วน).php';

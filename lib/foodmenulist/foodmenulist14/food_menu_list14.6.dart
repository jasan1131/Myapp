...
class FoodMenuList14_6 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList14_6({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList14_6> createState() => _FoodMenuList14_6State();
}

class _FoodMenuList14_6State extends State<FoodMenuList14_6> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ซีอิ๊วดำ).php';

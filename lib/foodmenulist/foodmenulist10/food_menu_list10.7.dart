...
class FoodMenuList10_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList10_7({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList10_7> createState() => _FoodMenuList10_7State();
}

class _FoodMenuList10_7State extends State<FoodMenuList10_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

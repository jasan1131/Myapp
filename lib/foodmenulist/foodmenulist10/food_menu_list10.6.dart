...
class FoodMenuList10_6 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList10_6({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList10_6> createState() => _FoodMenuList10_6State();
}

class _FoodMenuList10_6State extends State<FoodMenuList10_6> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(เต้าเจี้ยวตราเด็กสมบูรณ์ สูตร 1).php';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('เต้าเจี้ยวตราเด็กสมบูรณ์ สูตร 1'),
        actions: [
          IconButton(
                  ...
                  TextButton(
                    onPressed: () async {
                      ...
                      await SQLiteHelpper()
                          ...
                          .then((value) {
                        amountInt = 1;
                        Navigator.pop(context); Navigator.push(context, MaterialPageRoute(builder: (context) => ShowCart(),));
                      });
                    },
                    child: ShowTitle(
                      title: 'Add',

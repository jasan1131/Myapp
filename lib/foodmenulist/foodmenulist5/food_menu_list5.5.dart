...
class FoodMenuList5_5 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList5_5({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList5_5> createState() => _FoodMenuList5_5State();
}

class _FoodMenuList5_5State extends State<FoodMenuList5_5> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

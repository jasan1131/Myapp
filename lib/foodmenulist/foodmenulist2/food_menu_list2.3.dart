...
class FoodMenuList2_3 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList2_3({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList2_3> createState() => _FoodMenuList2_3State();
}

class _FoodMenuList2_3State extends State<FoodMenuList2_3> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(ซอสปรุงรสฝาเขียว).php';

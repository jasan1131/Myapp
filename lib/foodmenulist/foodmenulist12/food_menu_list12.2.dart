...
class FoodMenuList12_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList12_2({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList12_2> createState() => _FoodMenuList12_2State();
}

class _FoodMenuList12_2State extends State<FoodMenuList12_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ผักกระเฉด).php';

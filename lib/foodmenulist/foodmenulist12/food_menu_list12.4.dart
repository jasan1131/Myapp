...
class FoodMenuList12_4 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList12_4({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList12_4> createState() => _FoodMenuList12_4State();
}

class _FoodMenuList12_4State extends State<FoodMenuList12_4> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ปลาหมึกกล้วย).php';

...
class FoodMenuList19_8 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList19_8({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList19_8> createState() => _FoodMenuList19_8State();
}

class _FoodMenuList19_8State extends State<FoodMenuList19_8> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ใบโหระพา).php';

...
class FoodMenuList19_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList19_2({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList19_2> createState() => _FoodMenuList19_2State();
}

class _FoodMenuList19_2State extends State<FoodMenuList19_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

...
class FoodMenuList19_6 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList19_6({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList19_6> createState() => _FoodMenuList19_6State();
}

class _FoodMenuList19_6State extends State<FoodMenuList19_6> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

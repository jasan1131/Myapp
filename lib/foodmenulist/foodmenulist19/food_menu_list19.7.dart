...
class FoodMenuList19_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList19_7({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList19_7> createState() => _FoodMenuList19_7State();
}

class _FoodMenuList19_7State extends State<FoodMenuList19_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(พริกขี้หนู).php';

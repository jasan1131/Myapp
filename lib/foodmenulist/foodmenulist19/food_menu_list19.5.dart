...
class FoodMenuList19_5 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList19_5({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList19_5> createState() => _FoodMenuList19_5State();
}

class _FoodMenuList19_5State extends State<FoodMenuList19_5> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ซีอิ๊วขาว).php';

...
class FoodMenuList19_1 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList19_1({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList19_1> createState() => _FoodMenuList19_1State();
}

class _FoodMenuList19_1State extends State<FoodMenuList19_1> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(หอยลาย).php';

...
class FoodMenuList1_5 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList1_5({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList1_5> createState() => _FoodMenuList1_5State();
}

class _FoodMenuList1_5State extends State<FoodMenuList1_5> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(ซีอิ๊วดำ).php';

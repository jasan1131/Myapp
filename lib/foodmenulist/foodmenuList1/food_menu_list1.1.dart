...
class FoodMenuList1_1 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList1_1({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList1_1> createState() => _FoodMenuList1_1State();
}

class _FoodMenuList1_1State extends State<FoodMenuList1_1> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

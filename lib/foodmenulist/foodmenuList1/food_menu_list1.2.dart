...
class FoodMenuList1_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList1_2({ Key? key, required this.userModel }) : super(key: key);

  @override
  State<FoodMenuList1_2> createState() => _FoodMenuList1_2State();
}

class _FoodMenuList1_2State extends State<FoodMenuList1_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

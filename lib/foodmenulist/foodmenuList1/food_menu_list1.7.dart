...
class FoodMenuList1_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList1_7({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList1_7> createState() => _FoodMenuList1_7State();
}

class _FoodMenuList1_7State extends State<FoodMenuList1_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(น้ำตาลทราย).php';

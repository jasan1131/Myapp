...
class FoodMenuList1_9 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList1_9({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList1_9> createState() => _FoodMenuList1_9State();
}

class _FoodMenuList1_9State extends State<FoodMenuList1_9> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(คะน้าต้น).php';

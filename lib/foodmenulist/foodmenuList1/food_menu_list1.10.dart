...
class FoodMenuList1_10 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList1_10({ Key? key, required this.userModel }) : super(key: key);

  @override
  State<FoodMenuList1_10> createState() => _FoodMenuList1_10State();
}

class _FoodMenuList1_10State extends State<FoodMenuList1_10> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(แครอต).php';

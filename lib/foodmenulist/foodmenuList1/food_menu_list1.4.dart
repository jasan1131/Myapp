...
class FoodMenuList1_4 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList1_4({ Key? key, required this.userModel }) : super(key: key);

  @override
  State<FoodMenuList1_4> createState() => _FoodMenuList1_4State();
}

class _FoodMenuList1_4State extends State<FoodMenuList1_4> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(ก๋วยเตี๋ยวเส้นใหญ่).php';

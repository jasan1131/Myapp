...
class FoodMenuList20_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList20_7({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList20_7> createState() => _FoodMenuList20_7State();
}

class _FoodMenuList20_7State extends State<FoodMenuList20_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

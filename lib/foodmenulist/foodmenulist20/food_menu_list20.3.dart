...
class FoodMenuList20_3 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList20_3({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList20_3> createState() => _FoodMenuList20_3State();
}

class _FoodMenuList20_3State extends State<FoodMenuList20_3> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(บล็อกโคลี่).php';

...
class FoodMenuList20_4 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList20_4({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList20_4> createState() => _FoodMenuList20_4State();
}

class _FoodMenuList20_4State extends State<FoodMenuList20_4> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ถั่วลันเตาจีน).php';

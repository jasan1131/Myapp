...
class FoodMenuList20_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList20_2({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList20_2> createState() => _FoodMenuList20_2State();
}

class _FoodMenuList20_2State extends State<FoodMenuList20_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(แครอต).php';

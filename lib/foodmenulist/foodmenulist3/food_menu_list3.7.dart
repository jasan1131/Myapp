...
class FoodMenuList3_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList3_7({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList3_7> createState() => _FoodMenuList3_7State();
}

class _FoodMenuList3_7State extends State<FoodMenuList3_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(น้ำส้มสายชู).php';

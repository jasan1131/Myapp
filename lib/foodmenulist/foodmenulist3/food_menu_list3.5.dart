...
class FoodMenuList3_5 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList3_5({ Key? key, required this.userModel }) : super(key: key);

  @override
  State<FoodMenuList3_5> createState() => _FoodMenuList3_5State();
}

class _FoodMenuList3_5State extends State<FoodMenuList3_5> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(ปลาหมึกกล้วย).php';

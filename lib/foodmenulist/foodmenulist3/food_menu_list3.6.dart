...
class FoodMenuList3_6 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList3_6({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList3_6> createState() => _FoodMenuList3_6State();
}

class _FoodMenuList3_6State extends State<FoodMenuList3_6> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(พริกไทย).php';

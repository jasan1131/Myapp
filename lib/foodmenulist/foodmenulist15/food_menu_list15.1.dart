...
class FoodMenuList15_1 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList15_1({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList15_1> createState() => _FoodMenuList15_1State();
}

class _FoodMenuList15_1State extends State<FoodMenuList15_1> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(กะหล่ำปลีเขียว).php';

...
class FoodMenuList8_1 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList8_1({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList8_1> createState() => _FoodMenuList8_1State();
}

class _FoodMenuList8_1State extends State<FoodMenuList8_1> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ถั่วฝักยาว).php';

...
class FoodMenuList8_3 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList8_3({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList8_3> createState() => _FoodMenuList8_3State();
}

class _FoodMenuList8_3State extends State<FoodMenuList8_3> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(น้ำปลาตราหน่อไม้).php';

...
class FoodMenuList8_4 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList8_4({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList8_4> createState() => _FoodMenuList8_4State();
}

class _FoodMenuList8_4State extends State<FoodMenuList8_4> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(พริกแกง).php';

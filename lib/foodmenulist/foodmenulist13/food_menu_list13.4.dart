...
class FoodMenuList13_4 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList13_4({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList13_4> createState() => _FoodMenuList13_4State();
}

class _FoodMenuList13_4State extends State<FoodMenuList13_4> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(แตงกวา).php';

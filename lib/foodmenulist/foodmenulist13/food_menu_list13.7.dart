...
class FoodMenuList13_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList13_7({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList13_7> createState() => _FoodMenuList13_7State();
}

class _FoodMenuList13_7State extends State<FoodMenuList13_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ซอสมะเขือเทศ(ขวดใหญ่)).php';

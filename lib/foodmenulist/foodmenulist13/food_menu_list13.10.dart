...
class FoodMenuList13_10 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList13_10({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList13_10> createState() => _FoodMenuList13_10State();
}

class _FoodMenuList13_10State extends State<FoodMenuList13_10> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(น้ำมันมรกต).php';

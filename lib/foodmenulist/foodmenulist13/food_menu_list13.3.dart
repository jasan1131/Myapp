...
class FoodMenuList13_3 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList13_3({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList13_3> createState() => _FoodMenuList13_3State();
}

class _FoodMenuList13_3State extends State<FoodMenuList13_3> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(สับปะรด).php';

...
class FoodMenuList16_4 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList16_4({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList16_4> createState() => _FoodMenuList16_4State();
}

class _FoodMenuList16_4State extends State<FoodMenuList16_4> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ผักชีฝรั่ง).php';

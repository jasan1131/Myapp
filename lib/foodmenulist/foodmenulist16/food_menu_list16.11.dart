...
class FoodMenuList16_11 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList16_11({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList16_11> createState() => _FoodMenuList16_11State();
}

class _FoodMenuList16_11State extends State<FoodMenuList16_11> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(มะเขือเทศราชินี).php';

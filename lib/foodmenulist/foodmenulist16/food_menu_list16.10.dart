...
class FoodMenuList16_10 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList16_10({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList16_10> createState() => _FoodMenuList16_10State();
}

class _FoodMenuList16_10State extends State<FoodMenuList16_10> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ผักกาดขาว).php';

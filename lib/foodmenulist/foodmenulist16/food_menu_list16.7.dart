...
class FoodMenuList16_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList16_7({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList16_7> createState() => _FoodMenuList16_7State();
}

class _FoodMenuList16_7State extends State<FoodMenuList16_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(น้ำตาลทราย).php';

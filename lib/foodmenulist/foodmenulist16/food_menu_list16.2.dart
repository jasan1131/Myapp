...
class FoodMenuList16_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList16_2({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList16_2> createState() => _FoodMenuList16_2State();
}

class _FoodMenuList16_2State extends State<FoodMenuList16_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ตับหมู).php';

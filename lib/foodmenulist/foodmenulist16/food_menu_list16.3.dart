...
class FoodMenuList16_3 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList16_3({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList16_3> createState() => _FoodMenuList16_3State();
}

class _FoodMenuList16_3State extends State<FoodMenuList16_3> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(หอมแดง).php';

...
class FoodMenuList16_9 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList16_9({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList16_9> createState() => _FoodMenuList16_9State();
}

class _FoodMenuList16_9State extends State<FoodMenuList16_9> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ใบมะกรูด).php';

...
class FoodMenuList18_1 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList18_1({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList18_1> createState() => _FoodMenuList18_1State();
}

class _FoodMenuList18_1State extends State<FoodMenuList18_1> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ไข่ไก่).php';

...
class FoodMenuList18_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList18_7({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList18_7> createState() => _FoodMenuList18_7State();
}

class _FoodMenuList18_7State extends State<FoodMenuList18_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

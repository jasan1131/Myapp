...
class FoodMenuList18_4 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList18_4({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList18_4> createState() => _FoodMenuList18_4State();
}

class _FoodMenuList18_4State extends State<FoodMenuList18_4> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(ซอสปรุงรสฝาเขียว).php';

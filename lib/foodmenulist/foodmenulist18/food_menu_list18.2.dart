...
class FoodMenuList18_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList18_2({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList18_2> createState() => _FoodMenuList18_2State();
}

class _FoodMenuList18_2State extends State<FoodMenuList18_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

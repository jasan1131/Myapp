...
class FoodMenuList18_6 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList18_6({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList18_6> createState() => _FoodMenuList18_6State();
}

class _FoodMenuList18_6State extends State<FoodMenuList18_6> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

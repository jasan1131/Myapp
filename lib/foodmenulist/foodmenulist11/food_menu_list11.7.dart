...
class FoodMenuList11_7 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList11_7({Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList11_7> createState() => _FoodMenuList11_7State();
}

class _FoodMenuList11_7State extends State<FoodMenuList11_7> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

...
class ShowStatusBuyerAwaitOrder extends StatefulWidget {
  final OrderModel orderModel;
  const ShowStatusBuyerAwaitOrder({Key? key, required this.orderModel}) : super(key: key);

  @override
  State<ShowStatusBuyerAwaitOrder> createState() => _ShowStatusBuyerAwaitOrderState();
}

class _ShowStatusBuyerAwaitOrderState extends State<ShowStatusBuyerAwaitOrder> {

...
class BuyerWholeSaleProduct extends StatefulWidget {
  ...
  const BuyerWholeSaleProduct({Key? key, required this.userModel})
      : super(key: key);
...
class _BuyerWholeSaleProductState extends State<BuyerWholeSaleProduct> {
  ...
  bool load = true;
  bool? haveData;
  List<ProductModel> productmodles = [];
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereWsSeller.php';
      ...
      (value) {
        ...
        for (var item in result) {
          ...
          setState(() {
            load = false;
            haveData = true;
            productmodles.add(productModel);
          });
        }
      },
    );
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: CachedNetworkImage(
                        fit: BoxFit.fill,
                        imageUrl:
                            findUrlImage(productmodles[index].imagesproduct),
                  ...
                  Container(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ShowTitle(
                            title: productmodles[index].nameproduct,
                            textStyle: MyConstant().h2Style(),
                          ),
                          ShowTitle(
                            title:
                                'จำนวนสินค้า : ${productmodles[index].numberproduct}',
                            textStyle: MyConstant().h3Style(),
                          ),
                          ShowTitle(
                            title:
                                'ราคา : ${productmodles[index].priceproduct} บาท',
                            textStyle: MyConstant().h3Style(),
                          ),
                          ShowTitle(
                            title: cutWord(
                                'รายระเอียดสินค้า : ${productmodles[index].detailproduct}'),
                            textStyle: MyConstant().h3Style(),
                          ),
                        ],
                      ),

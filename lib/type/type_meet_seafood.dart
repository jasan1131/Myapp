...
class TypeMeetSeaFood extends StatefulWidget {
  final UserModel userModel;
  const TypeMeetSeaFood({Key? key, required this.userModel}) : super(key: key);

  @override
  State<TypeMeetSeaFood> createState() => _TypeMeetSeaFoodState();
}

class _TypeMeetSeaFoodState extends State<TypeMeetSeaFood> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereTypeSeafood.php';

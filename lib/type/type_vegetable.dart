...
class TypeVegatables extends StatefulWidget {
  ...
  const TypeVegatables({Key? key, required this.userModel}) : super(key: key);
...
class _TypeVegatablesState extends State<TypeVegatables> {
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereTypeVegetable.php';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ShowTitle(
                                title: cutWord('รายระเอียดสินค้า :'),
                                textStyle: MyConstant().h3Style(),
                              ),
                              ShowTitle(
                                title:

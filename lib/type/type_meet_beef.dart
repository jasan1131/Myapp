...
class TypeMeetBeef extends StatefulWidget {
  ...
  const TypeMeetBeef({Key? key, required this.userModel}) : super(key: key);

  @override
  State<TypeMeetBeef> createState() => _TypeMeetBeefState();
}

class _TypeMeetBeefState extends State<TypeMeetBeef> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

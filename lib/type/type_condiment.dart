...
class TypeCondiments extends StatefulWidget {
  final UserModel userModel;
  const TypeCondiments({Key? key, required this.userModel}) : super(key: key);

  @override
  State<TypeCondiments> createState() => _TypeCondimentsState();
}

class _TypeCondimentsState extends State<TypeCondiments> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereTypeCondiment.php';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('ประเภทเครื่องปรุงรส'),
        actions: [
          IconButton(

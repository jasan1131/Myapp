...
class TypeMeetPork extends StatefulWidget {
  ...
  const TypeMeetPork({Key? key, required this.userModel}) : super(key: key);

  @override
  State<TypeMeetPork> createState() => _TypeMeetPorkState();
}

class _TypeMeetPorkState extends State<TypeMeetPork> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

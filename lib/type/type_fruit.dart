...
class TypeFruit extends StatefulWidget {
  ...
  const TypeFruit({Key? key, required this.userModel}) : super(key: key);

  @override
  State<TypeFruit> createState() => _TypeFruitState();
}

class _TypeFruitState extends State<TypeFruit> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereTypeFruit.php';

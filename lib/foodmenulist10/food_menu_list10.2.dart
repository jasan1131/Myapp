...
class FoodMenuList10_2 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList10_2({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList10_2> createState() => _FoodMenuList10_2State();
}

class _FoodMenuList10_2State extends State<FoodMenuList10_2> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(หมูสามชั้น).php';

...
class FoodMenuList1_6 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList1_6({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList1_6> createState() => _FoodMenuList1_6State();
}

class _FoodMenuList1_6State extends State<FoodMenuList1_6> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;

...
class FoodMenuList1_8 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList1_8({ Key? key, required this.userModel }) : super(key: key);

  @override
  State<FoodMenuList1_8> createState() => _FoodMenuList1_8State();
}

class _FoodMenuList1_8State extends State<FoodMenuList1_8> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(ไข่ไก่).php';

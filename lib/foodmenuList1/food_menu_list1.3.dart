...
class FoodMenuList1_3 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList1_3({ Key? key, required this.userModel }) : super(key: key);

  @override
  State<FoodMenuList1_3> createState() => _FoodMenuList1_3State();
}

class _FoodMenuList1_3State extends State<FoodMenuList1_3> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI = '${MyConstant.domain}/shopping/getProductWhereNameProduct(หมูเนื้อแดงล้วน).php';

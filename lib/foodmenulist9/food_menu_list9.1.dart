...
class FoodMenuList9_1 extends StatefulWidget {
  final UserModel userModel;
  const FoodMenuList9_1({ Key? key, required this.userModel}) : super(key: key);

  @override
  State<FoodMenuList9_1> createState() => _FoodMenuList9_1State();
}

class _FoodMenuList9_1State extends State<FoodMenuList9_1> {
  UserModel? userModel;
  bool load = true;
  bool? haveData;
  ...
  Future<Null> readApiAllShop() async {
    String urlAPI =
        '${MyConstant.domain}/shopping/getProductWhereNameProduct(มักะโรนี).php';
